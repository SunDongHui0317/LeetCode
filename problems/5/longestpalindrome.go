...
内存消耗：2.5 MB, 在所有 Go 提交中击败了 99.98% 的用户
通过测试用例：180 / 180
Runtime: 6 ms, faster than 85.65% of Go online submissions for Longest Palindromic Substring.
Memory Usage: 2.7 MB, less than 75.68% of Go online submissions for Longest Palindromic Substring.
*/
